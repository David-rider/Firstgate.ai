...
def create_word_document(docx_path):
    ...
    add_body_p("品牌坚持「稳扎稳打、务实工程」原则，严禁编造任何夸大的虚拟数据（如虚假的数十万张 GPU 或百个数据中心），所有宣传与产品功能均建立在创始人自 1997 年起近三十年真实的 Enterprise IT、MSP 托管服务、路由交换组网、网络安全防御、金融合规（SOC2 / NY DFS）以及勒索病毒危机救援的硬核技术沉淀之上。")
